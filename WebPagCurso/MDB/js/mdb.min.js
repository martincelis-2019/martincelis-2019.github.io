...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInBack: function(t, e, n, i, a, r) { return void 0 == r && (r = 1.70158), i * (e /= a) * e * ((r + 1) * e - r) + n },
        easeOutBack: function(t, e, n, i, a, r) { return void 0 == r && (r = 1.70158), i * ((e = e / a - 1) * e * ((r + 1) * e + r) + 1) + n },
        easeInOutBack: function(t, e, n, i, a, r) { return void 0 == r && (r = 1.70158), (e /= a / 2) < 1 ? i / 2 * (e * e * ((1 + (r *= 1.525)) * e - r)) + n : i / 2 * ((e -= 2) * e * ((1 + (r *= 1.525)) * e + r) + 2) + n },
        ...
        return function(t, e, n, i) {
            ...
            function o(t, n, i, a) {
                ...
                S.getControlPoints = function() { return [{ x: t, y: n }, { x: i, y: a }] };
                            ...
                            for (var m = Math.min((e - h) / d.duration, 1), b = 0, x = s.length; x > b; b++) {
                                ...
                                if (r(S)) {
                                    ...
                                    if (d.display !== i && null !== d.display && "none" !== d.display) {
                                        if ("flex" === d.display) { c.each(["-webkit-box", "-moz-box", "-ms-flexbox", "-webkit-flex"], function(t, e) { y.setPropertyValue(S, "display", e) }) }
                                        y.setPropertyValue(S, "display", d.display)
                                    }
                                    for (var M in d.visibility !== i && "hidden" !== d.visibility && y.setPropertyValue(S, "visibility", d.visibility), k)
                                        if ("element" !== M) {
                                            var P, T = k[M],
                    ...
                    update: function(t, e, n) {
                        if (t) {
                            ...
                            i.each(h.concat(f, p, g), function(t) {
                                ...
                                n ? (e = t.update(t.fullWidth ? v : k, w), S -= e.height) : (e = t.update(x, S), k -= e.width), C.push({ horizontal: n, minSize: e, box: t })
                            });
                            var M = 0,
                                P = 0,
                                T = 0,
                            ...
                            i.each(h.concat(f), E), i.each(h, function(t) { I += t.width }), i.each(f, function(t) { _ += t.width }), i.each(p.concat(g), E), i.each(p, function(t) { D += t.height }), i.each(g, function(t) { F += t.height }), i.each(h.concat(f), function(t) {
                                var e = i.findNextWhere(C, function(e) { return e.box === t }),
                            ...
                            var R = n - D - F,
                                V = e - I - _;
                            V === k && R === S || (i.each(h, function(t) { t.height = R }), i.each(f, function(t) { t.height = R }), i.each(p, function(t) { t.fullWidth || (t.width = V) }), i.each(g, function(t) { t.fullWidth || (t.width = V) }), S = R, k = V);
                            var z = l + O,
                                N = c + L;
                            i.each(h.concat(p), W), z += k, N += S, i.each(f, W), i.each(g, W), t.chartArea = { left: I, top: D, right: I + k, bottom: D + S }, i.each(m, function(e) { e.left = t.chartArea.left, e.top = t.chartArea.top, e.right = t.chartArea.right, e.bottom = t.chartArea.bottom, e.update(k, S) })
                        }
                        ...
                        function W(t) { t.isHorizontal() ? (t.left = t.fullWidth ? l : I, t.right = t.fullWidth ? e - u : I + k, t.top = N, t.bottom = N + t.height, N = t.bottom) : (t.left = z, t.right = z + t.width, t.top = D, t.bottom = D + S, z = t.right) }
                    }
                }
            }, { 46: 46 }],
            32: [function(t, e, n) {
                        ...
                        if (n.display) {
                            ...
                            if (r.each(m, function(i, a) {
                                    if (!r.isNullOrUndef(i.label)) {
                                        ...
                                        P.push({ tx1: v, ty1: b, tx2: y, ty2: x, x1: k, y1: S, x2: C, y2: F, labelX: O, labelY: L, glWidth: u, glColor: c, glBorderDash: d, glBorderDashOffset: f, rotation: -1 * M, label: R, major: i.major, textBaseline: z, textAlign: V })
                                    }
                                }), r.each(P, function(t) {
                                ...
                                var F, O, L = 0,
                                    R = d(f) / 2;
                                if (g) F = e.left + (e.right - e.left) / 2, O = "bottom" === n.position ? e.bottom - R - C.bottom : e.top + R + C.top;
                                else {
                        ...
                        if (m ? (g.width = t.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = t.maxHeight), a)
                            if (o.font = f, m) {
                                ...
                                r.each(t.legendItems, function(t, e) {
                                    ...
                                    S + C > g.height && (w += k + n.padding, x.push(k), k = 0, S = 0), k = Math.max(k, i), S += C, p[e] = { left: 0, top: 0, width: i, height: c }
